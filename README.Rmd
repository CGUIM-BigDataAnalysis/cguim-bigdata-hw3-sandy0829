...
knitr::kable(
df1[1:12,c("Title","PushNum","Author")])
PPT<- "https://www.ptt.cc/bbs/Tech_Job/index1.html"
postTitle<- read_html(PPT) %>%
html_nodes(".title") %>%
html_text()
postPushNum<- read_html(PPT) %>%
...
knitr::kable(
df2[1:20,c("Title","PushNum","Author")])
PPT<- "https://www.ptt.cc/bbs/Tech_Job/index2.html"
postTitle<- read_html(PPT) %>%
html_nodes(".title") %>%
html_text()
postPushNum<- read_html(PPT) %>%
...
knitr::kable(
df3[1:20,c("Title","PushNum","Author")])
PPT<- "https://www.ptt.cc/bbs/Tech_Job/index3.html"
postTitle<- read_html(PPT) %>%
html_nodes(".title") %>%
html_text()
postPushNum<- read_html(PPT) %>%
...
knitr::kable(
df4[1:20,c("Title","PushNum","Author")])
PPT<- "https://www.ptt.cc/bbs/Tech_Job/index4.html"
postTitle<- read_html(PPT) %>%
html_nodes(".title") %>%
html_text()
postPushNum<- read_html(PPT) %>%
...
knitr::kable(
df5[1:20,c("Title","PushNum","Author")])
PPT<- "https://www.ptt.cc/bbs/Tech_Job/index5.html"
postTitle<- read_html(PPT) %>%
html_nodes(".title") %>%
html_text()
postPushNum<- read_html(PPT) %>%
...
knitr::kable(
df6[1:20,c("Title","PushNum","Author")])
